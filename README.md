# 👋 Kartik Varia
![Profile Views](https://komarev.com/ghpvc/?username=kartikv-04&label=Profile%20views&color=0e75b6&style=flat)

Full-stack engineer based in Vadodara. CS Graduate 2026. Stronger on the backend — I build APIs, auth systems, and real-time features. Currently looking for my next role.

[![Portfolio](https://img.shields.io/badge/Portfolio-000?style=flat-square&logo=vercel&logoColor=white)](https://kartikv-04.vercel.app/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/kartik-varia/)
...
|---|---|---|
| [Email Template Manager](https://github.com/kartikv-04/email-template-manager) | Next.js · Supabase · Resend · Gemini | Admin UI for non-technical teams to manage and send email templates with AI-assisted editing |
| [Threadr](https://github.com/kartikv-04/threadr) | Node.js · Socket.io · MongoDB | Real-time messaging with dual-layer JWT auth on REST and WebSocket, load tested across 9+ rooms |
